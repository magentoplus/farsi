...
$lang = array_merge($lang, array(
	...
	'BOARD_NOT_INSTALLED_EXPLAIN'	=> 'phpBB Unified Convertor Framework نیازمند نسخه پیشفرض phpBB3 است. <a href="%s">شروع نصب phpBB3</a>.',
	'BACKUP_NOTICE'					=> 'جهت پیشگیری از مشکلات قبل از آپدیت ، از دیتابیس خود حتما بک آپ تهیه کنید.',
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'با موفقیت تالارتان را به نسخه phpBB 3.1\'a تبدیل کردید،هم اکنون میتوانید وارد شوید و به <a href="../">تالارتان دسترسی پیدا کنید</a>. قبل از حذف کردن پوشه install و فعال سازی تالار، مطمئن شوید که تمامی تنظیمات با موفقیت منتقل شده اند. به یاد داشته باشید که میتوانید از <a href="http://www.phpbb.com/support/documentation/3.0/">Documentation</a> phpBB و <a href="http://www.phpbb.com/community/viewforum.php?f=46">انحمن های پشتیبانی</a>کمک بگیرید.',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		...
		<p>بعد از کلیک بر روی یکی از دو گزینه زیر به صفحه کنترل پنل مدیریت هدایت خواهید شد که در آنجا با فرمی رو به رو میشوید. اگر این فرم را پر کنید از شما سپاسگزار خواهیم شد.بعد از همه این ها باید کمی وقت صرف کنید تا با گزینه های مدیریت آشنا شوید. به یا داشته باشید که میتوانید از <a href="http://www.phpbb.com/support/documentation/3.0/">مستندات</a>, <a href="%3$s">README</a> و <a href="http://www.phpbb.com/community/viewforum.php?f=46">انجمن های پشتیبانی</a> کمک بگیرید. </p><p><strong>لطفا قبل از استفاده از تالا، پوشه install را حذف،تغییرنام و یا انتقال دهید. اگر این پوشه موجود باشد،فقط بخش کنترل پنل مدیر در دسترس خواهد بود.</strong>',
	...
	'INSTALL_SEND_CONFIG'		=> 'متاسفانه phpBB قادر به پیکربندی لازم جهت نوشتن روی فایل config.php را ندارد. این خطا ممکن است در نتیجه نبودن این فایل یا غیر قابل خوانده شدن آن باشد. تعدادی از گزینه های به صورت فعال و بعد از نصب کامل روی این فایل لیست میشوند. ',
	...
	'MYSQL_SCHEMA_UPDATE_REQUIRED'	=> 'طرح MYSQL شما برای phpBB منسوخ می باشد. phpBB طرحی را برای MySQL 3.x/4.x تشخیص داده است. ولی سرور در MYSWL %2$s اجرا میشود.<br /><strong>قبل از انجام فرآیند بروزرسانی، باید طرح (schema) را ارتقاء دهید</strong><br /><br />لطفا به <a href="http://www.phpbb.com/kb/article/doesnt-have-a-default-value-errors/">Knowledge Base article about upgrading the MySQL schema</a> مراجعه کنید. اگر مشکل ادامه داشت، لطفا با <a href="http://www.phpbb.com/community/viewforum.php?f=46">انجمن های پشتیبانی ما</a> تماس بگیرید.',
	...
	'PHP_SETTINGS_EXPLAIN'			=> '<strong>ضروری</strong> - برای نصب phpBB باید حداقل نسخه 5.3.3 PHP بر روی سرور نصب باشد. اگر در قسمت زیر <var>حالت امن</var> نمایش داده شود، PHP در این حالت نصب خواهد شد. این ویژگی به مدیریت از راه دور و مواردی از این قبیل محدودیت هایی اجرا خواهد کرد.',
	...
	'PHP_VERSION_REQD'				=> 'نسخه PHP >= 5.3.3',
	'POST_ID'						=> 'ID پست',
	...
	'SELECT_FORUM_GA'			=> 'در phpBB 3.1 اطلاعیه های سراسری در انجمن ها لینک میشود. انجمنی برای اطلاعیه های فعلی خود انتخاب کنید ( بعدا قابل تغییر است ):',
	...
	'STAGE_CREATE_TABLE_EXPLAIN'	=> 'جداول پایگاه داده phpBB 3.1 ایجاد و بعضی از اطلاعات قبلی هم جایگزاری شدند. برای اتمام نصب phpBB به مرحله بعدی مراجعه کنید.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'تمامی فایل ها به آخرین نسخه phpBB به روز رسانی شدند.',
	...
	'COLLECTING_FILE_DIFFS'			=> 'جمع آوری فایل های متفاوت',
	...
	'DATABASE_UPDATE_COMPLETE'			=> 'به روز رسانی پایگاه داده با موفقیت به اتمام رسید.',
	'DATABASE_UPDATE_CONTINUE'			=> 'ادامه جهت به روز رسانی دیتابیس',
	...
	'DATABASE_UPDATE_NOT_COMPLETED'		=> 'به روز رسانی دیتابیس هنوز به اتمام نرسیده است.',
	...
	'EVERYTHING_UP_TO_DATE'		=> 'تمام چیزها به آخرین نسخه phpBB به روز رسانی شده است. حال باید <a href="%1$s">وارد انجمن</a>شده و بررسی کنید که همه چیز به خوبی کار میکند. فراموش نکنید که باید پوشه install را حذف و یا تغییر نام بدهید. لطفا مشخصات سرور و پیکربندی انجمن خود را برای ما از <a href="%2$s">مرکز مدیریت</a> ارسال نمایید.',
	...
	'NO_UPDATE_FILES_OUTDATED'		=> 'دایرکتوری معتبری یافت نشد، لطفا اطمینان حاصل کنید که فایل های مربوطه را آپلود کرده اید.<br /><br />به نظر می رسد که نصب شما بروز .<strong>نیست</strong>  بروزرسانی ها برای نسخه کنونی phpBB %1$s شما موجود هستند، لطفا از <a href="http://www.phpbb.com/downloads/" rel="external">http://www.phpbb.com/downloads/</a> بازدید کنید تا بسته مناسبی را برای بروزرسانی از نسخه %2$s به نسخه %3$s بدست آورید.',
	...
	'RELEASE_ANNOUNCEMENT'		=> 'اطلاعیه سراسری',
	'RESULT'					=> 'نتیجه',
	...
	'SHOW_DIFF_DELETED'			=> 'نمایش محتوی فایل های',
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li>به <a href="http://www.phpbb.com/downloads/" title="http://www.phpbb.com/downloads/">phpBB.com صفحه بارگیری</a> بروید و آرشیو "Automatic Update Package" را بارگیری کنید.<br /><br /></li>
	...
	'UPDATE_FILE_SUCCESS'			=> 'به روز رسانی فایل ها موفقیت آمیز بود.',
...
چنانچه از نحوه کار با این سیستم اطلاعاتی ندارید و دنبال قالب های شکیل و مدرن به صورت فارسی و همچنین افزونه های قدرتمند فارسی هستید میتوانید به <a href="http://www.php-bb.ir/forum/" title="http://www.php-bb.ir/forum/">مرجع پشتیبانی فارسی</a> phpBB در ایران مراجعه کنید. 
',
